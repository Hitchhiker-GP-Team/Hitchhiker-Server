...
export class likePostNotificationService implements NotificationService {
    ...
    async gnerateNotification(initiator : String, referenceId : String ): Promise<Notification> {
        ...
        if ( (fullnoti.initiatorsCntr! - fullnoti.initiatorsList!.length) > 0) {
            fullnoti.message = fullnoti.initiatorsList![0] + " and " + (fullnoti.initiatorsCntr!-1) + " others " + fullnoti.body
        ...
        {
            fullnoti.message = fullnoti.initiatorsList![0] + " and " + fullnoti.initiatorsList![1] + " " + fullnoti.body    
        }
